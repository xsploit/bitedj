...
Reports decoder range and first-read success; it does NOT prove native Engine cue
...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix='bitedj-timeline-') as temp:
        ...
        print('PASS actual providers: WAV, CBR/VBR MP3, AAC, FLAC; ranges and first reads.')
